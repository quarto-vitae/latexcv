...
: A category in `what` paired with its members, given either as one string in
  ...
  upstream's own does with its rated fields — its listings are set in a column a
  third of the page wide, where a rating beside a category would crowd or wrap
  it.
